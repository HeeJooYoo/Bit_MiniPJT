...
//		model.addAttribute("product", product);
	...
	public Map<String, Object> listProduct(HttpServletRequest request, @RequestParam  Map<String, Object> map) throws Exception {
...
//		Map<String, Object> map = new HashMap<String, Object>();
		...
		map.put("order", (String)request.getParameter("searchOrder"));			
//		
...
//		System.out.println(currentPage);
	...
	public List<String> getKeyword(@RequestParam("keyWord") String keyword) throws Exception {
		...
		System.out.println("encod	ing 후 " + keyword);
