...
<body>
	...
	<div class="container">
		<div class="page-header">
	       ...
	       <h5 class="text-muted"><strong class="text-danger">구매한 상품</strong>을 확인하세요.</h5>
	    </div>
		...
		<div class="row">
			...
			<div class="col-xs-8 col-md-4" id="guestName">${purchase.receiverName}</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-8 col-md-4" id="guestPhone">${purchase.receiverPhone}</div>
		</div>
